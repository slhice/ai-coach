...
export const BehaviorConfig: React.FC<BehaviorConfigProps> = ({ config, setConfig }) => {
  const [newGuideline, setNewGuideline] = useState('');

  const handleBehaviorChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    setConfig({
      ...config,
      coaching: {
        ...config.coaching,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium leading-6 text-gray-900">AI Coach Behavior</h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Define the core behavior and personality of your AI coach.
          </p>
          <textarea
            id="behavior"
            name="behavior"
            rows={6}
            value={config.coaching?.behavior || ''}
