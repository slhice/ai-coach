...
export const InstructionsConfig: React.FC<InstructionsConfigProps> = ({ config, setConfig }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium leading-6 text-gray-900">AI Coach Instructions</h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            name="instructions"
            rows={6}
            value={config.coaching?.instructions || ''}
